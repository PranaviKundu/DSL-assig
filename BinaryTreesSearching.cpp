...
//     if (!root) return false;
//     if (root->data == val) return true;
//     return val < root->data ? searchBST(root->left, val) : searchBST(root->right);
// }
...
//     Node* root = nullptr;
//     Node* bstRoot = nullptr;
//     Node* bstFromArray = nullptr;
//     Node* clonedTree = nullptr;
//     Node* mirroredTree = nullptr;
...
//                 break;
//             case 5:
//                 bstFromArray = createBST(arr, 0, 6);
//                 cout << "BST Created from Array.\n";
//                 break;
//             case 11:
//                 if (isTreeEmpty(bstRoot) || isTreeEmpty(bstFromArray)) break;
//                 cout << (isEqual(bstRoot, bstFromArray) ? "Trees are Equal\n" : "Trees are NOT Equal\n");
//                 break;
//             case 0:
//                 cout << "Exiting...\n";
//                 break;
